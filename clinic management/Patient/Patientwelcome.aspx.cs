...
{
    public partial class Patientwelcome : System.Web.UI.Page
    {
            ...
            protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                con.Open();
                Userinfo user = (Userinfo)Session["Username"];
                string query = @"  SELECT `FirstName`, `LastName`, `Cnic`, `Email`, `Contact`, `Qualification`, `Specialization` FROM `cms`.`profile` where ProfileId =" + user.Id;
