...
{
    public partial class Updatereceptionist : System.Web.UI.Page
    {
        MySqlConnection con;
        ...
        protected void btnupdateclinic_ServerClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtFirstname.Value.ToString() != null && txtLastname.Value.ToString() != ""
                    && txtcnic.Value.ToString() != null && txtc.Text.ToString() != ""
                    ...
                    )
                {
                    ...
                    string query = @"update `cms`.`profile`
                                    set `FirstName` = '" + txtFirstname.Value + "', `LastName` = '" + txtLastname.Value + "', Cnic = '" + txtcnic.Value + "', `Contact` = '" + txtc.Text.ToString() + "', `Email` = '" + txtEmail.Value.ToString() + "', `Address` = '" + txtAddress.Value.ToString()
                    ...
                    {
                        lblMsg.Text = "Error to update ViewReceptionist....";
            ...
            catch (Exception ex)
            {
                ...
                lblMsg.Text = "Error to update ViewReceptionist:" + ex.Message;
                lblMsg.ForeColor = System.Drawing.Color.Red;
            }
            finally
            {
